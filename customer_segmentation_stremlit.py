...
st.markdown("""<font size="2">注意&nbsp;:&nbsp;主要分析一年內的資料，若顧客最近一次消費日期超過一年，R(Recency)部份將給予相同權重分數1分。</font>""", unsafe_allow_html=True)
...
try:
    ...
    if uploaded_file is not None:
        ...
        ax.scatter(kmeans.cluster_centers_[:,0],kmeans.cluster_centers_[:,1],kmeans.cluster_centers_[:,2],
                  s=100,marker='^', c='red', alpha=0.7, label='Centroids')
        st.pyplot(fig)
    ...
    ●小計金額:限數字<br><br>
    3.使用上若仍有問題，按右上角☆旁選單&nbsp;<b><font color="Red">Report a bug with this app</font></b>&nbsp;通知，謝謝。</font>
    """,unsafe_allow_html=True)
